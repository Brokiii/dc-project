     ...
     const onButtonClick = () => {
           ...
           /* fetch('SamplePDF.pdf').then(response => {
                response.blob().then(blob => {
                    ...
                    alink.href = "https://drive.google.com/file/d/1KYoZNbAx4FYqlTyPlE-wkUnw17NG5LVl/view?usp=share_link";
            ...
            //ReactPDF.render(<MyDocument />, `${C:/Users/tomek/Pulpit/example.pdf}`);
            /*
                ReactDOM.render(
    ...
    return (
        <Container fixed className={classes.root}>
            ...
            <Container fixed className={classes.section}>
                ...
                <PDFDownloadLink document={<MyDocument />} fileName={"Polisa.pdf"}>
                    <button className="button-client"> Download </button>
                </PDFDownloadLink>
